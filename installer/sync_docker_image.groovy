...
node('ossworker && dockerfile && x64') {
  dir(env.WORKSPACE) {
    ...
    timeout(time: 8, unit: 'HOURS') {
      // Sync to OpenAnolis
      sh "wget https://raw.githubusercontent.com/dragonwell-releng/jenkinsUserContent/master/installer/DragonwellImageSyncer.java && javac DragonwellImageSyncer.java && java DragonwellImageSyncer"
    }
    timeout(time: 8, unit: 'HOURS') {
