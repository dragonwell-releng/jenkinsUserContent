        ...
        stage('iterateHistory') {
            ...
            steps {
                script {
                    ...
                    sh "git clean -ffdx"
                    sh "./tfb --network-mode='host'  --database-host='172.31.141.248' --client-host='172.31.141.248' --server-host='172.31.141.247' --concurrency-levels=[4, 8, 16, 32, 64, 128]  --pipeline-concurrency-levels=[128, 256, 512, 1024] --duration 30 --test ${test}"
